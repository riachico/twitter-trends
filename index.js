...
const options = {
	method: 'POST',
	headers: {
		'x-rapidapi-key': 'b60c47da79mshb63f0bbcb7e3ac7p1b0c4ajsnacd2cbd6d5e3',
...
.then(data => {
    ...
    //Map method = specific to arrays and creates a new array
...
// //Push method - adding elements to an array
